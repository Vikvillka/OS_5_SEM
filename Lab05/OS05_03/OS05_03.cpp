...
void childThread()
{
	...
	for (int i = 0; i < 1000000; i++)
	{
		if (i % 1000 == 0)
		{
			...
			cout << "Идентификатор процесса: " << pid << "\nИдентификатор потока: " << tid << endl;
...
int main(int argc, char* argv[])
{
	...
	/*case 1:
		...
		P3 = THREAD_PRIORITY_NORMAL (3);
		P4 = THREAD_PRIORITY_NORMAL (3);
	case 2:
		P1 = 0xff (255);
		P2 = NORMAL_PRIORITY_CLASS (3);
		P3 = THREAD_PRIORITY_LOWEST (1);
		P4 = THREAD_PRIORITY_HIGHEST (5);
	case 3:
		P1 = 0x01 (1);
		P2 = NORMAL_PRIORITY_CLASS (3);
		P3 = THREAD_PRIORITY_LOWEST (1);
