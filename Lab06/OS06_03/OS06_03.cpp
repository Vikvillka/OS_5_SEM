...
int main()
{
	...
	processes[0] = createProcess(L"D:\\5_SEM_LABS\\OS\\Lab06\\x64\\Debug\\OS06_03A.exe").hProcess;
	processes[1] = createProcess(L"D:\\5_SEM_LABS\\OS\\Lab06\\x64\\Debug\\OS06_03B.exe").hProcess;
